...
package io.github.mucheng.mce.annotations

/**
 * The annotation attach to the experimental APIs.
 * */
@RequiresOptIn(
    message = "This API is experimental, maybe happen something unexpected BUG.",
